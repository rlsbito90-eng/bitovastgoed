...
describe('productiekernBrowserWriteClient', () => {
  ...
  it('stelt de atomische batch-gepostactie beschikbaar via de browsercompositie',()=>{const s=stelProductiekernBrowserWritesSamen(groeneWerkCrmOmgeving(),uitvoerders());expect(s.transactieRepository.markeerBatchGepost).toBeTypeOf('function')});
