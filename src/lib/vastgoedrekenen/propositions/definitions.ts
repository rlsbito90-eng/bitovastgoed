...
export const PROPOSITION_DEFINITIONS: readonly PropositionDefinition[] = [
  ...
  define("vacant_commercial", "Leegstaand commercieel vastgoed", "Analyse van leegstaand commercieel vastgoed.", ["none", "renovate", "transform"], ["hold", "sell_vacant", "sell", "defer"], ["manual_value", "scenario_exit"]),
  define("renovate_and_sell", "Renoveren en doorverkopen", "Aankoop, renovatie en verkoop.", ["renovate"], ["sell"], ["scenario_exit", "residual_cost_profit", "residual_gdv_profit"], ["development_costs", "valuation", "risks"]),
  define("sell_off", "Uitponden", "Verkoop van afzonderlijke delen of eenheden.", ["none", "renovate", "split"], ["sell_vacant", "sell_tenanted", "sell"], ["component_sale_value"]),
  define("transformation", "Transformatie", "Functiewijziging met ontwikkel- en exitspoor.", ["transform", "split", "renovate"], ["hold", "sell", "defer"], ["scenario_exit", "residual_cost_profit", "residual_gdv_profit"]),
  ...
  define("mixed_use", "Mixed-use", "Gecombineerde gebruiksfuncties en waarderingssporen.", ["none", "renovate", "transform", "split"], ["hold", "sell_vacant", "sell_tenanted", "sell", "defer"], ["noi_nar", "component_sale_value", "scenario_exit"]),
