...
export const LEGACY_STRATEGY_TAXONOMY: Record<LegacyStrategyType, LegacyStrategyMapping> = {
  ...
  huur_optimaliseren: {
    ...
    disposition: 'hold',
    confidence: 'inferred',
    warnings: ['De legacycode maakt niet duidelijk of naast herverhuur ook renovatie of verduurzaming plaatsvindt.'],
  },
  renoveren_verhuren: {
    businessCase: 'value_add',
  ...
  verkopen_geheel: {
    ...
    disposition: 'undecided',
    confidence: 'ambiguous',
    warnings: ['De legacycode vermeldt niet of het object leeg of verhuurd als geheel wordt verkocht.'],
  },
  verkoop_per_unit: {
    businessCase: 'asset_disposal',
    intervention: 'none',
  ...
  buy_fix_sell: {
    ...
    expansionSubtype: null,
    exploitation: 'vacant',
    disposition: 'sell_as_whole_vacant',
    confidence: 'inferred',
