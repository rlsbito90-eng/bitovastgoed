...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    data-mobile-scroll-row
    className={cn(
      "inline-flex min-h-11 max-w-full items-center justify-start gap-1 overflow-x-auto rounded-md bg-muted p-1 text-muted-foreground sm:min-h-10 sm:justify-center",
      className,
    )}
    {...props}
  />
