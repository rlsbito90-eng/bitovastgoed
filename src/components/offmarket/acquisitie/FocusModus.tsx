...
export default function FocusModus({
  ...
  useEffect(() => {
    ...
    // Alleen initialiseren bij openen of scopewijziging.
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [open, beschikbareIds.join('|')]);

  // Wanneer het huidige item verdwijnt (uit de acquisitieselectie verwijderd),
  // open het volgende beschikbare item. Wanneer de lijst leeg raakt: sluit.
