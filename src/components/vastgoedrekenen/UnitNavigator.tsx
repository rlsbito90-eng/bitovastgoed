...
// Geen rekenlogica — alleen UX. Werkt voor zowel WWS- als Componentstrategie-units.
...
type Props = {
  units: NavUnit[];
  anchorPrefix: string; // bv. 'wws-unit' of 'strategy-unit'
};
    ...
    <div className="flex flex-wrap items-center gap-1.5 rounded-md border border-dashed bg-muted/20 px-2 py-1.5">
      ...
      {units.map((u, idx) => (
        ...
        >
          ...
          <span className="truncate max-w-[120px]">{u.label}</span>
