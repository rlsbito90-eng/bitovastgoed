  ...
  return (
    <div className="space-y-3">
      ...
      <PlainLanguageHelp
        ...
        warning={<>De maximale leenruimte is niet automatisch een opname. Alleen negatieve projectkasstromen worden gefinancierd. LTV en DSCR volgen pas zodra de waardebasis en netto exploitatiekasstroom per periode betrouwbaar zijn.</>}
      />
