...
const sql = fs.readFileSync(
  path.join(root, 'supabase/migrations/20260823165500_woonvorming_post_brief3_variant_b.sql'),
  'utf8',
).toLowerCase();

describe('woonvorming post brief 3 variant B migration', () => {
  it('activeert de challenger met gelijk gewicht en primaire KPI', () => {
    ...
    expect(sql).toContain("'woonvorming_post_brief_3_b_v1'");
