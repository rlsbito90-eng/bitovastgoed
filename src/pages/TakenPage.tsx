  ...
  return (
    <div className="page-shell">
      ...
      {zichtbaar.length === 0 ? (
        <EmptyState
          icon={<ListChecks />}
          title="Geen taken in deze weergave"
          description="Wissel van tabblad of pas je filters aan. Of maak direct een nieuwe taak aan."
          action={
            <button
              type="button"
              onClick={() => { setEditTaak(null); setFormOpen(true); }}
