  ...
  return <div className="page-shell-wide min-w-0 overflow-x-hidden">
    ...
    <div className="grid min-w-0 gap-4 lg:grid-cols-[minmax(0,1fr)_320px]">
      <div className="min-w-0 space-y-4">
        ...
        <section className="section-card min-w-0 p-4 sm:p-5"><div className="flex items-center gap-2"><ClipboardCheck className="h-4 w-4"/><h2 className="font-medium">BAG-context</h2></div><p className="mt-1 text-xs text-muted-foreground">BAG-identifiers worden uit de bronkoppeling overgenomen en zijn hier niet vrij wijzigbaar.</p><div className="mt-4 grid gap-3 sm:grid-cols-2"><div><Label>BAG-pand-ID</Label><p data-testid="bag-pand-id-readonly" className="mt-1 rounded-md border bg-muted/30 px-3 py-2 font-mono-data text-sm break-all">{kans.bagPandId||'Niet gekoppeld'}</p></div><div><Label>BAG-verblijfsobject-ID</Label><p data-testid="bag-vbo-id-readonly" className="mt-1 rounded-md border bg-muted/30 px-3 py-2 font-mono-data text-sm break-all">{kans.bagVerblijfsobjectId||'Niet gekoppeld'}</p></div></div></section>
