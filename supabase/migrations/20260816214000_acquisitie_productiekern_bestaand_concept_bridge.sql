...
--
-- Promoveert de eerder geïsoleerd gereviewde bridge naar een echte migratie.
-- Alleen de publieke wrapper is client-callable. De interne implementatie blijft
-- dicht en alle tabelmutaties verlopen binnen één security-definer transactie.
...
grant execute on function public.off_market_bestaand_concept_koppelen(
  uuid, uuid, uuid, text, timestamptz, jsonb, jsonb
) to authenticated;
