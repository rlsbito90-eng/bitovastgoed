-- Off-Market Radar: uitbreiding assettype-enum met wonen-gerelateerde opties.
-- Idempotent via IF NOT EXISTS zodat herhaalde runs veilig zijn.
...
-- De RPC off_market_promote_to_object mapt off_market_assettype → asset_class.
-- Voor de nieuwe waarden vullen we de mapping aan zodat promote niet faalt op
-- het CASE-default-pad (mixed_use) voor woon-signalen.
