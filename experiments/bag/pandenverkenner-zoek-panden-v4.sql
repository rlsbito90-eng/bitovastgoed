-- BUILD 1D.4 kandidaat — NIET automatisch toepassen.
-- Additieve zoekfunctie naast v3; v3 blijft fallback.
-- Binnen wijkcodes en buurtcodes geldt OR; tussen filtergroepen geldt AND.

CREATE OR REPLACE FUNCTION bag_service.zoek_panden_v4(
  p_scope_code text,
...
BEGIN
  ...
  SELECT
    ...
    i.primair_postcode, i.primair_plaats, i.adres_count, i.gemeente_code, i.gemeente_naam,
    i.wijk_code, i.wijk_naam, i.buurt_code, i.buurt_naam, i.centroid, i.pand_geometrie,
...
-- v3 blijft ongewijzigd als fallback.
